...
# This script crate huge amount of sctp connections to test
# connection  tracking subsystem in linux kernel.
# The sigle iperf3 sctp stream can reflect conntrack hash matching speed.
...
#	ip netns exec C iperf3 --sctp -c 10.0.1.99 --cport 8888 -t 0 --forceflush &
#	sleep 3
	...
	# 1 thread
#	ip netns exec S ./server -s -H 10.0.1.100 -P 1001-1500 &
#	ip netns exec C ./client -s -H 10.0.1.100 -P 1001-1500 -h 10.0.2.101,10.0.2.102,10.0.2.103,10.0.2.104,10.0.2.105 -p "50001-60000" &

	# 6 threads
	ip netns exec S ./server -s -H 10.0.1.100,10.0.1.101,10.0.1.102,10.0.1.103,10.0.1.104,10.0.1.105 -P 1001-1500 &
	ip netns exec C ./client -s -H 10.0.1.100,10.0.1.101,10.0.1.102,10.0.1.103,10.0.1.104,10.0.1.105 -P 1001-1500 \
	...
	# IPv6
	# 1 thread
#	ip netns exec S ./server -s -H 2000::100 -P 1001-1500 &
#	ip netns exec C ./client -s -H 2000::100 -P 1001-1500 -h 2001::100,2001::101,2001::102,2001::103,2001::104,2001::105 -p 50001-60000 &

	# 6 threads
#	ip netns exec S ./server -s -H 2000::100,2000::101,2000::102,2000::103,2000::104,2000::105 -P 1001-1500 &
#	ip netns exec C ./client -s -H 2000::100,2000::101,2000::102,2000::103,2000::104,2000::105 -P 1001-1500 -h 2001::100,2001::101,2001::102,2001::103,2001::104,2001::105 -p 50001-60000 &
	...
	#ip netns exec C netperf -4 -L 10.0.2.103 -H 10.0.1.103 -s TCP_CRR -l 100000 &
	#sleep 5
